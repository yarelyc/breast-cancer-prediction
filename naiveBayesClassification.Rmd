...
_Whats a popular radius mean when looking at an infected area_
...
lines(density(fit$tables$radius_worst[2,]), col="cyan")
...
```{r}
plot(density(dat[dat$diagnosis == "None",]$texture_worst), col="cyan", main="Mean")
...
for (tr_size in tr_sizes) {
  ...
  fit = naiveBayes(diagnosis ~ radius_worst + concave.points_worst + texture_worst, data=tr_dat1)
...
plot(range(tr_sizes), range(te_errs, tr_errs), type='n', xlab='Size of Data', ylab='Error')

lines(tr_sizes, tr_errs, col='cyan')
