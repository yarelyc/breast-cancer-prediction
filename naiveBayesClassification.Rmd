...
_We start with really high errors but as more data is introduced our error vastly minimizes and stablizes_
```{r}
te_errs = c()
tr_errs = c()
...
for (tr_size in tr_sizes) {
  ...
  fit = rpart(diagnosis ~ radius_worst + texture_worst + concave.points_worst, data=tr_dat1)
